...
namespace ClientPltTurbine.Pages.Component.MaintenanceComponent
{
    public class MaintenanceClass: CommonMethod, IEventMaintenance
    {
        ...
        internal Task SaveMaintenanceForTurbine(Dictionary<string, (int, string, string, bool)> infoTurbineMaintenance) => Controller.SaveMaintenanceTurbines(infoTurbineMaintenance);
    }
}
